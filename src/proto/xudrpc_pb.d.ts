...
export class CreateNodeResponse extends jspb.Message { 
    ...
    setInitializedRaiden(value: boolean): CreateNodeResponse;
...
export class GetInfoResponse extends jspb.Message { 
    ...
    setRaiden(value?: RaidenInfo): GetInfoResponse;
...
export class Peer extends jspb.Message { 
    ...
    setRaidenAddress(value: string): Peer;
...
export class RaidenInfo extends jspb.Message { 
    getStatus(): string;
    setStatus(value: string): RaidenInfo;

    getAddress(): string;
    setAddress(value: string): RaidenInfo;


    hasChannels(): boolean;
    clearChannels(): void;
    getChannels(): Channels | undefined;
    setChannels(value?: Channels): RaidenInfo;

    getVersion(): string;
    setVersion(value: string): RaidenInfo;

    getChain(): string;
    setChain(value: string): RaidenInfo;
...
export class RestoreNodeRequest extends jspb.Message { 
    ...
    setRaidenDatabase(value: Uint8Array | string): RestoreNodeRequest;

    getRaidenDatabasePath(): string;
    setRaidenDatabasePath(value: string): RestoreNodeRequest;
...
export class RestoreNodeResponse extends jspb.Message { 
    ...
    setRestoredRaiden(value: boolean): RestoreNodeResponse;
...
export class UnlockNodeResponse extends jspb.Message { 
    ...
    setUnlockedRaiden(value: boolean): UnlockNodeResponse;
